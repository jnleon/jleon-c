...
namespace ExceptionHandling
{
    class Program
    {
        ...
        {
            //int[] array = [1, 2, 3]; //wrong syntax for array initialization


            try
            {
                int[] array2 = { 1, 2, 3 };
                array2[5] = 4;   //run time indexout of bounds exception
            }
            catch(Exception e)
            {
                //do nothing i don't care just resume the program execution
            }

            string str = "bla";
           // int x = int.Parse(str); Format exception
            ...
            */
            ...
            try
            {
                ...
                int errorInt = int.Parse("not an int"); //this exception would be caught by Exception e, BUT we never make it here
            }
            ...
            {
                Console.WriteLine("Generic catch all");
            }
            finally //executes regardless of if finished try or caught exception
            {
                Console.WriteLine("finally done");
            }

            Console.WriteLine("this also executes if finished try or caught an excpetion because the program resumes execution");
