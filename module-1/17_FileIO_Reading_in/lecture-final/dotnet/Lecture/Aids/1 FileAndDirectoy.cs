        ...
        */
        ...
        {            
            ...
            if (!directoryExists)
            {
                ...
                if (Directory.Exists(@"C:\TestDirectory\SubDirectory")) //getting the list of subdirectories fails if it doesn't exist
                {
        ...
        */
        public static void UsingTheFileClass() 
        {
            ...
            if (fileExists)
            {
                ...
                Console.WriteLine("the file was copied and then deleted");
            }
        }
