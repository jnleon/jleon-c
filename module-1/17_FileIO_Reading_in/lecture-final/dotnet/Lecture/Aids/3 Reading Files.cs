    ...
    public static class ReadingInFiles
    {
        ...
        public static void ReadACharacterFile()
        {
            ...
            try
            {
                ...
                //i can use a StreamReader without the using but then I have to remember to close it
                StreamReader bla = new StreamReader("C:\\tests.txt");
                bla.Close();

            }
            catch(Exception e)
            {
                Console.WriteLine("Katie's example of creating a StreamReader without using using tries to read a file that doesn't exist.");
            }
