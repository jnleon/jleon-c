...
ALTER TABLE customer_purchases
 ADD CONSTRAINT fk_customer_purchases_customer foreign key (customerId) references customers (customerId)

ALTER TABLE customer_purchases
  ADD CONSTRAINT fk_customer_purchases_art foreign key (artCodeId) references art(artCodeId) 
  */

/*
ALTER TABLE table_name
ADD CONSTRAINT constraint_name CHECK (has to be true in order to add or modify a row column_name = 'Value' OR column_name IN (values))
*/
