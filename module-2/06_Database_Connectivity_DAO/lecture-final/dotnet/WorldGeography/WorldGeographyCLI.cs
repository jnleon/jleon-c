...
namespace WorldGeography
{
    public class WorldGeographyCLI
    {
        ...
        const string Command_CountriesByLanguage = "8";
        ...
        public void RunCLI()
        {
            ...
            while (true)
            {
                ...
                switch (command.ToLower())
                {
                    ...
                    case Command_CountriesByLanguage:
                        CountriesByLanguage();
                        break;
        ...
        private void PrintMenu()
        {
            ...
            Console.WriteLine(" 8 - Get a list of the countries that speak a particular language");
